...
def read_data(mdata1):
    ...
    re_1_in = nc_m_1.variables['lwp_per_in'][:]
    re_1_out = nc_m_1.variables['lwp_per_out'][:]
    re_1_c_in = nc_m_1.variables['lwp_con_in'][:]
    re_1_c_out = nc_m_1.variables['lwp_con_out'][:]
...
#fig, (axs0, axs1) = plt.subplots(1, 2, figsize=(16, 12))
#it used to be 40 for paper
font_legend = 60
font_lable = 60
...
axs0.annotate('(a)',xy=(-15,0.076),size=font_lable)
axs1.annotate('(b)',xy=(-40,0.076),size=font_lable)
plt.tight_layout()
axs0.grid(True)
axs1.grid(True)
#plt.savefig('/home/mhaghigh/PycharmProjects/paper_Holo/revised_paper_output/lwp_no_label_fig5.png')
#plt.savefig('/home/mhaghigh/PycharmProjects/paper_Holo/revised_paper_output/lwp_no_label_fig5.pdf')
#plt.savefig('lwp_poster.png', dpi=500)
plt.show()
